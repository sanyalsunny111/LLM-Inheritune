...
export HF_HOME=/scratch/07946/ss95332/huggingface
...
python scripts/download.py --repo_id openlm-research/open_llama_7b --checkpoint_dir /sample/checkpoints/openlm-research/open_llama_7b
